...
goog.require('yantra.datatypes');
yantra.graphics.BoundingBox = (function (){var obj9374 = {};return obj9374;
})();
...
yantra.graphics.expand_plot_range = (function expand_plot_range(bounding_box,image_size){var vec__9379 = bounding_box;var vec__9380 = cljs.core.nth.call(null,vec__9379,0,null);var xmin = cljs.core.nth.call(null,vec__9380,0,null);var ymin = cljs.core.nth.call(null,vec__9380,1,null);var vec__9381 = cljs.core.nth.call(null,vec__9379,1,null);var xmax = cljs.core.nth.call(null,vec__9381,0,null);var ymax = cljs.core.nth.call(null,vec__9381,1,null);var vec__9382 = image_size;var image_width = cljs.core.nth.call(null,vec__9382,0,null);var image_height = cljs.core.nth.call(null,vec__9382,1,null);var width = Math.abs.call(null,(xmax - xmin));var height = Math.abs.call(null,(ymax - ymin));var plotaspect = (height / width);var imageaspect = (image_height / image_width);if((plotaspect < imageaspect))
...
yantra.graphics.coordinate_transformer = (function coordinate_transformer(bounding_box,image_size){var vec__9389 = yantra.graphics.expand_plot_range.call(null,bounding_box,image_size);var vec__9390 = cljs.core.nth.call(null,vec__9389,0,null);var xmin = cljs.core.nth.call(null,vec__9390,0,null);var ymin = cljs.core.nth.call(null,vec__9390,1,null);var vec__9391 = cljs.core.nth.call(null,vec__9389,1,null);var xmax = cljs.core.nth.call(null,vec__9391,0,null);var ymax = cljs.core.nth.call(null,vec__9391,1,null);var vec__9392 = image_size;var image_width = cljs.core.nth.call(null,vec__9392,0,null);var image_height = cljs.core.nth.call(null,vec__9392,1,null);var width = Math.abs.call(null,(xmax - xmin));var height = Math.abs.call(null,(ymax - ymin));return (function (p__9393){var vec__9394 = p__9393;var x = cljs.core.nth.call(null,vec__9394,0,null);var y = cljs.core.nth.call(null,vec__9394,1,null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [((x - xmin) * (image_width / width)),(image_height - ((y - ymin) * (image_height / height)))], null);
});
});
yantra.graphics.distance_transformer = (function distance_transformer(bounding_box,image_size){var vec__9399 = bounding_box;var vec__9400 = cljs.core.nth.call(null,vec__9399,0,null);var xmin = cljs.core.nth.call(null,vec__9400,0,null);var ymin = cljs.core.nth.call(null,vec__9400,1,null);var vec__9401 = cljs.core.nth.call(null,vec__9399,1,null);var xmax = cljs.core.nth.call(null,vec__9401,0,null);var ymax = cljs.core.nth.call(null,vec__9401,1,null);var vec__9402 = image_size;var image_width = cljs.core.nth.call(null,vec__9402,0,null);var image_height = cljs.core.nth.call(null,vec__9402,1,null);var width = Math.abs.call(null,(xmax - xmin));var height = Math.abs.call(null,(ymax - ymin));return (function (d){return (d * (image_width / width));
});
});
yantra.graphics.listplot = (function listplot(l){return (new yantra.datatypes.Graphics(cljs.core.vec.call(null,cljs.core.map_indexed.call(null,(function (p1__9403_SHARP_,p2__9404_SHARP_){return (new yantra.datatypes.Point(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__9403_SHARP_,p2__9404_SHARP_], null)));
}),l))));
});
yantra.graphics.points_to_svg_string = (function points_to_svg_string(points){return cljs.core.apply.call(null,cljs.core.str,cljs.core.interpose.call(null," ",cljs.core.map.call(null,(function (p1__9405_SHARP_){return [cljs.core.str(cljs.core.first.call(null,p1__9405_SHARP_)),cljs.core.str(","),cljs.core.str(cljs.core.last.call(null,p1__9405_SHARP_))].join('');
}),points)));
});
...
}),yantra.datatypes.Graphics,(function (cursor,owner,opts){var builder = om.core.get_shared.call(null,owner,new cljs.core.Keyword(null,"builder","builder",1244848909));var bb = yantra.graphics.bounding_box.call(null,new cljs.core.Keyword(null,"contents","contents",4741549708).cljs$core$IFn$_invoke$arity$1(om.core.value.call(null,cursor)));var coordfn = yantra.graphics.coordinate_transformer.call(null,bb,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [200,200], null));var distancefn = yantra.graphics.distance_transformer.call(null,bb,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [200,200], null));return React.DOM.svg({"height": 200, "width": 200},cljs.core.into_array.call(null,cljs.core.map.call(null,(function (p1__9407_SHARP_){return builder.call(null,p1__9407_SHARP_,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"opts","opts",1017322386),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"coord-fn","coord-fn",4768239122),coordfn,new cljs.core.Keyword(null,"distance-fn","distance-fn",4584217874),distancefn], null)], null));
