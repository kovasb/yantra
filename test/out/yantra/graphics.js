...
goog.require('yantra.datatypes');
yantra.graphics.BoundingBox = (function (){var obj9221 = {};return obj9221;
})();
...
yantra.graphics.expand_plot_range = (function expand_plot_range(bounding_box,image_size){var vec__9226 = bounding_box;var vec__9227 = cljs.core.nth.call(null,vec__9226,0,null);var xmin = cljs.core.nth.call(null,vec__9227,0,null);var ymin = cljs.core.nth.call(null,vec__9227,1,null);var vec__9228 = cljs.core.nth.call(null,vec__9226,1,null);var xmax = cljs.core.nth.call(null,vec__9228,0,null);var ymax = cljs.core.nth.call(null,vec__9228,1,null);var vec__9229 = image_size;var image_width = cljs.core.nth.call(null,vec__9229,0,null);var image_height = cljs.core.nth.call(null,vec__9229,1,null);var width = Math.abs.call(null,(xmax - xmin));var height = Math.abs.call(null,(ymax - ymin));var plotaspect = (height / width);var imageaspect = (image_height / image_width);if((plotaspect < imageaspect))
...
yantra.graphics.coordinate_transformer = (function coordinate_transformer(bounding_box,image_size){var vec__9236 = yantra.graphics.expand_plot_range.call(null,bounding_box,image_size);var vec__9237 = cljs.core.nth.call(null,vec__9236,0,null);var xmin = cljs.core.nth.call(null,vec__9237,0,null);var ymin = cljs.core.nth.call(null,vec__9237,1,null);var vec__9238 = cljs.core.nth.call(null,vec__9236,1,null);var xmax = cljs.core.nth.call(null,vec__9238,0,null);var ymax = cljs.core.nth.call(null,vec__9238,1,null);var vec__9239 = image_size;var image_width = cljs.core.nth.call(null,vec__9239,0,null);var image_height = cljs.core.nth.call(null,vec__9239,1,null);var width = Math.abs.call(null,(xmax - xmin));var height = Math.abs.call(null,(ymax - ymin));return (function (p__9240){var vec__9241 = p__9240;var x = cljs.core.nth.call(null,vec__9241,0,null);var y = cljs.core.nth.call(null,vec__9241,1,null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [((x - xmin) * (image_width / width)),(image_height - ((y - ymin) * (image_height / height)))], null);
});
});
yantra.graphics.distance_transformer = (function distance_transformer(bounding_box,image_size){var vec__9246 = bounding_box;var vec__9247 = cljs.core.nth.call(null,vec__9246,0,null);var xmin = cljs.core.nth.call(null,vec__9247,0,null);var ymin = cljs.core.nth.call(null,vec__9247,1,null);var vec__9248 = cljs.core.nth.call(null,vec__9246,1,null);var xmax = cljs.core.nth.call(null,vec__9248,0,null);var ymax = cljs.core.nth.call(null,vec__9248,1,null);var vec__9249 = image_size;var image_width = cljs.core.nth.call(null,vec__9249,0,null);var image_height = cljs.core.nth.call(null,vec__9249,1,null);var width = Math.abs.call(null,(xmax - xmin));var height = Math.abs.call(null,(ymax - ymin));return (function (d){return (d * (image_width / width));
});
});
yantra.graphics.listplot = (function listplot(l){return (new yantra.datatypes.Graphics(cljs.core.vec.call(null,cljs.core.map_indexed.call(null,(function (p1__9250_SHARP_,p2__9251_SHARP_){return (new yantra.datatypes.Point(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__9250_SHARP_,p2__9251_SHARP_], null)));
}),l))));
});
yantra.graphics.graphics_renderers = new cljs.core.PersistentArrayMap.fromArray([yantra.datatypes.Style,(function (cursor,owner,opts){var e = om.core.value.call(null,cursor);var coordfn = new cljs.core.Keyword(null,"coord-fn","coord-fn",4768239122).cljs$core$IFn$_invoke$arity$1(opts);var distancefn = new cljs.core.Keyword(null,"distance-fn","distance-fn",4584217874).cljs$core$IFn$_invoke$arity$1(opts);var builder = om.core.get_shared.call(null,owner,new cljs.core.Keyword(null,"builder","builder",1244848909));return React.DOM.g(cljs.core.clj__GT_js.call(null,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",1123684643),new cljs.core.Keyword(null,"style","style",1123684643).cljs$core$IFn$_invoke$arity$1(e)], null)),(((cljs.core.seq_QMARK_.call(null,new cljs.core.Keyword(null,"prims","prims",1120839167).cljs$core$IFn$_invoke$arity$1(e))) || (cljs.core.vector_QMARK_.call(null,new cljs.core.Keyword(null,"prims","prims",1120839167).cljs$core$IFn$_invoke$arity$1(e))))?cljs.core.into_array.call(null,cljs.core.map.call(null,(function (p1__9252_SHARP_){return builder.call(null,p1__9252_SHARP_,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"opts","opts",1017322386),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"coord-fn","coord-fn",4768239122),coordfn,new cljs.core.Keyword(null,"distance-fn","distance-fn",4584217874),distancefn], null)], null));
