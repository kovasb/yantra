...
goog.require('yantra.datatypes');
yantra.graphics.BoundingBox = (function (){var obj9207 = {};return obj9207;
})();
...
yantra.graphics.expand_plot_range = (function expand_plot_range(bounding_box,image_size){var vec__9212 = bounding_box;var vec__9213 = cljs.core.nth.call(null,vec__9212,0,null);var xmin = cljs.core.nth.call(null,vec__9213,0,null);var ymin = cljs.core.nth.call(null,vec__9213,1,null);var vec__9214 = cljs.core.nth.call(null,vec__9212,1,null);var xmax = cljs.core.nth.call(null,vec__9214,0,null);var ymax = cljs.core.nth.call(null,vec__9214,1,null);var vec__9215 = image_size;var image_width = cljs.core.nth.call(null,vec__9215,0,null);var image_height = cljs.core.nth.call(null,vec__9215,1,null);var width = Math.abs.call(null,(xmax - xmin));var height = Math.abs.call(null,(ymax - ymin));var plotaspect = (height / width);var imageaspect = (image_height / image_width);if((plotaspect < imageaspect))
...
yantra.graphics.coordinate_transformer = (function coordinate_transformer(bounding_box,image_size){var vec__9222 = yantra.graphics.expand_plot_range.call(null,bounding_box,image_size);var vec__9223 = cljs.core.nth.call(null,vec__9222,0,null);var xmin = cljs.core.nth.call(null,vec__9223,0,null);var ymin = cljs.core.nth.call(null,vec__9223,1,null);var vec__9224 = cljs.core.nth.call(null,vec__9222,1,null);var xmax = cljs.core.nth.call(null,vec__9224,0,null);var ymax = cljs.core.nth.call(null,vec__9224,1,null);var vec__9225 = image_size;var image_width = cljs.core.nth.call(null,vec__9225,0,null);var image_height = cljs.core.nth.call(null,vec__9225,1,null);var width = Math.abs.call(null,(xmax - xmin));var height = Math.abs.call(null,(ymax - ymin));return (function (p__9226){var vec__9227 = p__9226;var x = cljs.core.nth.call(null,vec__9227,0,null);var y = cljs.core.nth.call(null,vec__9227,1,null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [((x - xmin) * (image_width / width)),(image_height - ((y - ymin) * (image_height / height)))], null);
});
});
yantra.graphics.distance_transformer = (function distance_transformer(bounding_box,image_size){var vec__9232 = bounding_box;var vec__9233 = cljs.core.nth.call(null,vec__9232,0,null);var xmin = cljs.core.nth.call(null,vec__9233,0,null);var ymin = cljs.core.nth.call(null,vec__9233,1,null);var vec__9234 = cljs.core.nth.call(null,vec__9232,1,null);var xmax = cljs.core.nth.call(null,vec__9234,0,null);var ymax = cljs.core.nth.call(null,vec__9234,1,null);var vec__9235 = image_size;var image_width = cljs.core.nth.call(null,vec__9235,0,null);var image_height = cljs.core.nth.call(null,vec__9235,1,null);var width = Math.abs.call(null,(xmax - xmin));var height = Math.abs.call(null,(ymax - ymin));return (function (d){return (d * (image_width / width));
});
});
yantra.graphics.listplot = (function listplot(l){return (new yantra.datatypes.Graphics(cljs.core.vec.call(null,cljs.core.map_indexed.call(null,(function (p1__9236_SHARP_,p2__9237_SHARP_){return (new yantra.datatypes.Point(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__9236_SHARP_,p2__9237_SHARP_], null)));
}),l))));
});
...
}),yantra.datatypes.Graphics,(function (cursor,owner,opts){var builder = om.core.get_shared.call(null,owner,new cljs.core.Keyword(null,"builder","builder",1244848909));var bb = yantra.graphics.bounding_box.call(null,new cljs.core.Keyword(null,"contents","contents",4741549708).cljs$core$IFn$_invoke$arity$1(om.core.value.call(null,cursor)));var coordfn = yantra.graphics.coordinate_transformer.call(null,bb,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [200,200], null));var distancefn = yantra.graphics.distance_transformer.call(null,bb,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [200,200], null));return React.DOM.svg({"height": 200, "width": 200},cljs.core.into_array.call(null,cljs.core.map.call(null,(function (p1__9238_SHARP_){return builder.call(null,p1__9238_SHARP_,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"opts","opts",1017322386),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"coord-fn","coord-fn",4768239122),coordfn,new cljs.core.Keyword(null,"distance-fn","distance-fn",4584217874),distancefn], null)], null));
